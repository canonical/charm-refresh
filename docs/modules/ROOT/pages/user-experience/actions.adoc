...
[#pre-refresh-check-user-docs]
==== Part 1: User docs URL
...
[#pre-refresh-check-rollback-command]
==== Part 2: Rollback command
...
[#pre-refresh-check-pause-after]
==== Part 3: pause-after-unit-refresh confirmation

[#pre-refresh-check-pause-after-all]
===== pause-after-unit-refresh is all
...
result: |-
  ...
  The refresh will pause for your manual confirmation after each unit refreshes. To change this, set the `pause-after-unit-refresh` config option. Run `juju config {ex-charm}` for more information
----

[#pre-refresh-check-pause-after-first]
===== pause-after-unit-refresh is first
...
result: |-
  ...
  The refresh will pause for your manual confirmation after the first unit refreshes. To change this, set the `pause-after-unit-refresh` config option. Run `juju config {ex-charm}` for more information
----

[#pre-refresh-check-pause-after-none]
===== pause-after-unit-refresh is none
...
result: |-
  ...
  The refresh will not pause for your manual confirmation. To change this, set the `pause-after-unit-refresh` config option. Run `juju config {ex-charm}` for more information
----
...
After the user runs `juju refresh`, if xref:user-experience/config.adoc#pause-after-unit-refresh[pause-after-unit-refresh] is set to `all` or `first`, the refresh will pause.
...
(If the automatic checks fail, the charm will pause the refresh regardless of the value of xref:user-experience/config.adoc#pause-after-unit-refresh[pause-after-unit-refresh].)
...
[.wrap]
----
Action id 2 failed: `pause-after-unit-refresh` config is set to `none`. This action is not applicable.
----
