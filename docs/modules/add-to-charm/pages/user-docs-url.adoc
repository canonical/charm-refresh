...
charmhub.io:
  locations:
    /{ex-charm}/docs/refresh/{ex-track}/: # <.>
      ...
      extra-config: ['return 307 https://canonical.com/data/{ex-charm-vm}/docs/{ex-track}/how-to/refresh/k8s/'] # <.>
----
...
<.> Replace `https://canonical.com/data/{ex-charm-vm}/docs/{ex-track}/how-to/refresh/k8s/` with the <<target>>
...
. Request a review at https://concordia.canonical.com/request/IS/is-pull-request-review
